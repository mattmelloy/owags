...
arcgis_server_webadaptor 'Uninstall Web Adaptor for Portal' do
...
arcgis_server_webadaptor 'Uninstall Web Adaptor for Server' do
  install_dir node['arcgis']['web_adaptor']['install_dir']
...
arcgis_server_portal 'Uninstall Portal for ArcGIS' do
...
arcgis_server_datastore 'Uninstall ArcGIS DataStore' do
...
arcgis_server_server 'Uninstall ArcGIS Server' do
